            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title fw-semibold mb-4">Barrowed Lists</h5>
                                    ...
                                    <table class="table text-nowrap mb-0 align-middle ">
                                        <thead class="text-dark fs-4">
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-0">Date Returned</h6>
                                                </th>
                                                <th class="border-bottom-0">
                                                    <h6 class="fw-semibold mb-0">Returned</h6>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM borrow WHERE status = 2";
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    // echo $row["cover"];
                                                    // echo "Borrower: " . $row["borrower"] . "<br>";
                                                    // echo "Title: " . $row["tittle"] . "<br>";
                                                    // echo "Writer: " . $row["writter"] . "<br>";
                                                    // echo "Description: " . $row["disc"] . "<br>";
                                                    $disc = $row['disc'];
                                                    $date_borrowed = $row["date_returned"];
                                                    $datetimeString = $date_borrowed;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border-bottom-0">
                                                            <div class="d-flex align-items-center">
                                                                <img src="<?php echo $row["cover"] ?>" width="130" alt="">
                                                                <div class="ms-3">
                                                                    <h6 class="fw-semibold mb-1"><?php echo $row["tittle"] ?>
                                                                    </h6>
                                                        ...
                                                        <td class="border-bottom-0">
                                                            <p class="mb-0 fw-normal text-uppercase">
                                                                <?php echo $row["borrower"] ?></p>
                                                        </td>
                                                        <td class="border-bottom-0">
                                                            <div class="d-flex align-items-center">
                                                        ...
                                                        <td class="border-bottom-0">
                                                            <span class="badge bg-success "><i class="ti ti-check"></i>Returned
                                                            </span>
                                                        </td>
                                                    </tr>
                                            <?php
